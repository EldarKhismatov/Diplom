...
### **UI сценарии перехода к форме оплаты путешествия**
...
1. В поле "Месяц" ввести невалидное значение (истекший срок действия карты)

**ОР:** Поле "Месяц" подсвечивает сообщение: "Неверно указан срок действия карты"

2. В поле "Месяц" ввести номер месяца больше 12 (цифра 13)
...
1. В поле "Владелец" ввести имя, фамилию на русской раскладке клавиатуры.

**ОР:** Поле "Владелец" подсвечивает сообщение: "недопустимые символы"

2. В поле "Владелец" ввести только имя
...
1. В поле "CVC/CVV" ввести "нули"

**ОР:** Под полем "CVC/CVV" появляется валидационное сообщение "Неверный формат";

2. В поле "CVC/CVV" ввести только 2 цифры (невалидное значение)
...
3. Подготовка отчетов о проведении тестирования - 12 часов# Diplom
